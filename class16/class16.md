...
Note that we used the mapIDs() function above to obtain Entrez gene IDs (stored in res\_entrez) and we have the fold change results from DESeq2 analysis (stored in res\_log2FoldChange).
...
```
    ...
    ## Info: Working in directory C:/Users/Rachel/Desktop/Rachel/UCSD/Winter 2019/BIMM 143/Bimm143_GitHub/class16
